...
### ВКР:  
* Hololens (картографирование, навигация, интерфейс пользователя) - исследование, проектирование, разработка, эксперимент
* Сервер (локализация, ML, 3DSmoothNet) - исследование, прооектирование
